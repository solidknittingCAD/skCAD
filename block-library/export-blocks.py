	...
	for child in obj.children:
		if child.type == 'CURVE':
			...
			def append_yarn(cps):
				...
				if len(cps) == 1:
					print("  ERROR: yarn contains only 1 control point.")
					sys.exit(1)
				...
				if begin != None and face_types[begin] == "x":
					print("  ERROR: yarn starts on empty face.")
					sys.exit(1)
				if end != None and face_types[end] == "x":
					print("  ERROR: yarn ends on empty face.")
					sys.exit(1)
